...
## 7. Deliverables & Repository
**Repository name:** `<your_matr_number>_fcl-adaptive-controller`  
**Contents:** Code, README.md, CSV logs, demo notebook, plots & figures.  
If private, grant read access to:  
- `apacha`, `padraig20` (GitHub) or `apacha` (TU Wien GitLab).

---

## 8. Submission
Send an email to **applied-deep-learning@outlook.com** with subject:  
`[Applied Deep Learning] Exercise 1 - <Your Matr.Number>`  
Include your repository link.  
Please allow time for confirmation before resending.